...
<head>
    ...
    <script>
        function buyProduct(idBarangBuy, jumlahBuy){
            if (idBarangBuy == "" || jumlahBuy == "" || jumlahBuy < 1) {
                document.getElementById("buyNotif").innerHTML = "";
                return;
            } else {
...
<body>
    ...
    <form method="POST">
        ...
        <input type="submit" name="Buy" value="Buy" onclick="buyProduct(this.idBarangBuy, this.jumlahBuy)">
    </form> 

    <br>
    <div id="buyNotif"><b>Buy notification here....</b></div> <br>
    <br>
